...
void setup() {
  ...
  climateSensor.setOversampling(TemperatureSensor,Oversample16); // 16x sampling to temperature
  climateSensor.setOversampling(HumiditySensor,SensorOff); // Don't measure humidity
  climateSensor.setOversampling(PressureSensor,Oversample8); // 8x oversampling for pressure
